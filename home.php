  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>DWitter is developed by <span style="font-weight: 700;">Madhullika</span>  for DELTA Lateral inductions.</p>
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          ...
          <div class="grid-sidebar bg-active" style="margin-top: 12px">
            ...
            <div class="wrapper-left-elements">
              <a class="wrapper-left-active" href="home.php" style="margin-top: 5px;"><strong>Home</strong></a>
            </div>
          </div>
          </a>
      ...
      <div class="grid-posts">
                      ...
                      <form class="" action="handle/handleTweet.php" method="post" enctype="multipart/form-data">
                        <div class="inner">
                          ...
                          <label>
                            ...
                            <textarea class="text-whathappen" name="status" rows="10" cols="110" placeholder="Your tweet"></textarea>
                        ...
                        <div class="bottom"> 
                         ...
                         <?php } } unset($_SESSION['errors_tweet']); ?>
                          <div>
                            ...
                            <span class="bioCount" id="count">300</span>
        ...
        <div class="wrapper-right">
          ...
          <input type="text" class="form-control search-input"  placeholder="Search on Twitter">
          ...
          <div class="box-share">
            <p class="txt-share"><strong>Suggested followers</strong></p>
            <?php 
